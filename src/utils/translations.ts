export const translations = {
  en: {
    ...
    landing: {
      ...
      description:
        "A comprehensive platform for worker registration, establishment management, and departmental oversight in the construction industry.",
      ...
      featuresSubtitle:
        "Comprehensive solutions for all stakeholders in the construction industry",
      quickAccess: "Quick Access",
      quickAccessSubtitle: "Choose your role to get started",
      whyChoose: "Why Choose WorkerConnect?",
      whyChooseSubtitle:
        "Our platform provides comprehensive solutions for the construction industry, ensuring transparency, efficiency, and compliance.",
      getStartedToday: "Get Started Today",
      getStartedTodaySubtitle:
        "Join thousands of workers and establishments already using our platform.",
      startRegistration: "Start Registration",
      workerRegistrationDesc:
        "Register as a construction worker and access benefits",
    ...
    establishment: {
      ...
      declaration: "Declaration",
      declarationText:
        "As per my knowledge the information shared is correct and I also declare that child labour is not in use. I understand that providing false information may result in legal consequences and cancellation of registration.",
    ...
    mobile: {
      downloadApp: "Download Mobile App",
      getStarted: "Get the native app for the best experience",
      ...
      downloadApp: "Download Mobile App",
      downloadNow: "Download Now",
      getStarted: "Get the mobile app for a better experience",
      features: "App Features",
      installSteps: "Installation Steps",
      troubleshooting: "Troubleshooting",
      support: "Need Help?",
    ...
    mobile: {
      ...
      lastUpdated: "Last Updated",
      requirements: "Requirements",
      downloadApk: "Download APK for Android",
      downloadIpa: "Download IPA for iOS",
      features: "App Features",
      installSteps: "Installation Steps",
      troubleshooting: "Troubleshooting",
      support: "Need Help?",
    ...
    downloadApk: "Download Android APK",
      ...
      iosInstructions: "1. Download the IPA file\n2. Use AltStore or similar tool to install\n3. Trust the developer certificate\n4. Open WorkerConnect app",
      systemRequirements: "System Requirements",
      androidRequirements: "Android 7.0 (API level 24) or higher",
      iosRequirements: "iOS 12.0 or higher",
    },
    mobile: {
      downloadApp: "Download Mobile App",
  ...
  te: {
    ...
    landing: {
      ...
      description:
        "నిర్మాణ పరిశ్రమలో కార్మిక నమోదు, సంస్థ నిర్వహణ మరియు శాఖీయ పర్యవేక్షణ కోసం సమగ్ర వేదిక.",
      ...
      featuresSubtitle:
        "నిర్మాణ పరిశ్రమలోని అన్ని వాటాదారుల కోసం సమగ్ర పరిష్కారాలు",
      ...
      whyChooseSubtitle:
        "మా ప్లాట్‌ఫారమ్ నిర్మాణ పరిశ్రమ కోసం సమగ్ర పరిష్కారాలను అందిస్తుంది, పారదర్శకత, సామర్థ్యం మరియు సమ్మతిని నిర్ధారిస్తుంది.",
      getStartedToday: "ఈరోజే ప్రారంభించండి",
      getStartedTodaySubtitle:
        "ఇప్పటికే మా ప్లాట్‌ఫారమ్‌ను ఉపయోగిస్తున్న వేలాది కార్మికులు మరియు సంస్థలతో చేరండి.",
      startRegistration: "నమోదు ప్రారంభించండి",
      workerRegistrationDesc:
        "నిర్మాణ కార్మికుడిగా నమోదు చేసుకుని ప్రయోజనాలను పొందండి",
    ...
    worker: {
      ...
      declaration: "ప్రకటన",
      declarationText:
        "అందించిన అన్ని సమాచారం నా జ్ఞానం మేరకు నిజమైనది మరియు సరైనదని నేను దీని ద్వారా ప్రకటిస్తున్నాను.",
      ...
      locationPermissionHelp:
        "చెక్ ఇన్/అవుట్ చేయడానికి దయచేసి లొకేషన్ సేవలను ప్రారంభించండి",
    ...
    establishment: {
      ...
      declaration: "ప్రకటన",
      declarationText:
        "నా జ్ఞానం మేరకు పంచుకున్న సమాచారం సరైనదని మరియు బాల కార్మికులను ఉపయోగించడం లేదని నేను ప్రకటిస్తున్నాను. తప్పుడు సమాచారం అందించడం వల్ల చట్టపరమైన పరిణామాలు మరియు నమోదు రద్దు కావచ్చని నేను అర్థం చేసుకున్నాను.",
    ...
    notifications: {
      ...
      maintenanceMode:
        "సిస్టమ్ నిర్వహణలో ఉంది. దయచేసి తర్వాత మళ్లీ ప్రయత్నించండి.",
    },
    status: {
      active: "చురుకైన",
      inactive: "నిష్క్రియ",
    ...
    pwa: {
      ...
      iosInstructions:
        'షేర్ బటన్‌ను నొక్కి "హోమ్ స్క్రీన్‌కు జోడించు"ను ఎంచుకోండి',
    ...
    mobile: {
      downloadApp: "మొబైల్ యాప్ డౌన్‌లోడ్ చేయండి",
      getStarted: "ఉత్తమ అనుభవం కోసం నేటివ్ యాప్‌ని పొందండి",
      ...
      pushNotifications: "రియల్-టైమ్ పుష్ నోటిఫికేషన్‌లు",
      ...
      downloadApp: "మొబైల్ యాప్ డౌన్‌లోడ్ చేయండి",
      downloadNow: "ఇప్పుడే డౌన్‌లోడ్ చేయండి",
      getStarted: "మెరుగైన అనుభవం కోసం మొబైల్ యాప్‌ని పొందండి",
      features: "యాప్ ఫీచర్లు",
      installSteps: "ఇన్‌స్టాలేషన్ దశలు",
      troubleshooting: "సమస్య పరిష్కారం",
      support: "సహాయం కావాలా?",
    ...
    mobile: {
      ...
      lastUpdated: "చివరిగా నవీకరించబడింది",
      requirements: "అవసరాలు",
      downloadApk: "Android కోసం APK డౌన్‌లోడ్ చేయండి",
      downloadIpa: "iOS కోసం IPA డౌన్‌లోడ్ చేయండి",
      features: "యాప్ ఫీచర్లు",
      installSteps: "ఇన్‌స్టాలేషన్ దశలు",
      troubleshooting: "సమస్య పరిష్కారం",
      support: "సహాయం కావాలా?",
      ...
      locationTracking: "హాజరు కోసం ఖచ్చితమైన లొకేషన్ ట్రాకింగ్",
      cameraIntegration: "పత్రాల అప్‌లోడ్‌ల కోసం కెమెరా ఇంటిగ్రేషన్",
      biometricAuth: "భద్రత కోసం బయోమెట్రిక్ ప్రమాణీకరణ",
      installationGuide: "ఇన్‌స్టాలేషన్ గైడ్",
      androidGuide: "Android ఇన్‌స్టాలేషన్ గైడ్",
      ...
      downloadIpa: "iOS IPA డౌన్‌లోడ్ చేయండి",
      installInstructions: "ఇన్‌స్టాలేషన్ సూచనలు",
      androidInstructions: "1. APK ఫైల్‌ను డౌన్‌లోడ్ చేయండి\n2. సెట్టింగ్స్‌లో 'తెలియని మూలాలు'ను ప్రారంభించండి\n3. APK ఫైల్‌ను ఇన్‌స్టాల్ చేయండి\n4. వర్కర్‌కనెక్ట్ యాప్‌ను తెరవండి",
      iosInstructions: "1. IPA ఫైల్‌ను డౌన్‌లోడ్ చేయండి\n2. ఇన్‌స్టాల్ చేయడానికి AltStore లేదా సారూప్య సాధనాన్ని ఉపయోగించండి\n3. డెవలపర్ సర్టిఫికేట్‌ను విశ్వసించండి\n4. వర్కర్‌కనెక్ట్ యాప్‌ను తెరవండి",
      systemRequirements: "సిస్టమ్ అవసరాలు",
      androidRequirements: "Android 7.0 (API స్థాయి 24) లేదా అంతకంటే ఎక్కువ",
      iosRequirements: "iOS 12.0 లేదా అంతకంటే ఎక్కువ",
      availableOn: "అందుబాటులో",
      android: "Android",
      ios: "iOS",
      fileSize: "ఫైల్ పరిమాణం",
      version: "వెర్షన్",
      lastUpdated: "చివరిగా నవీకరించబడింది",
      requirements: "అవసరాలు",
      features: "మొబైల్ లక్షణాలు",
      offlineAccess: "ఆఫ్‌లైన్ ప్రవేశం",
      pushNotifications: "పుష్ నోటిఫికేషన్లు",
