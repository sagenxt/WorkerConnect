...
export function formatWorkerPayload(formData: any) {
  ...
  return {
    ...
    perDistrictCode: perDistrict?.name || null,
    perCityId: Number(formData.permanentAddress?.mandal || 0),
    perCityCode: formData.permanentAddress?.mandalLabel || null,
    ...
    preDistrictCode: preDistrict?.name || null,
    preCityId: Number(formData.presentAddress?.mandal || 0),
    preCityCode: formData.presentAddress?.mandalLabel || null,
